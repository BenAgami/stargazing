...
result: issue
reported: "I can change the name of the workout but I can't add a new exercise to it"
severity: major
...
result: issue
reported: "I can't have more than one exercise in a workout. I can add only one and when I try to add another one, it changes the previous"
severity: major
...
- truth: "In edit mode, the workout builder allows adding new exercises via the exercise catalog picker round-trip"
  status: failed
